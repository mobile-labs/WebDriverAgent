...
/*! Returns 'value' or nil if 'value' is an empty string or AX error string */
#define FBTransferAXErrorStringToNil(value) \
    ([value isEqual:@"AX error -25205"] || [value isEqual:@""] ? nil : value)
...
/*! Returns 'value1' or 'value2' if 'value1' is an empty or AX error string */
#define FBFirstNonAXErrorValue(value1, value2) \
    (value1 == nil || [value1 isEqual:@""] || [value1 isEqual:@"AX error -25205"] ? value2 : value1)
